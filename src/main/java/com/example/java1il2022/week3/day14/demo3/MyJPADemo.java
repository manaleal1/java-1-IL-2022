package com.example.java1il2022.week3.day14.demo3;
...
//        properties.put("hibernate.show_sql", "true");
    ...
    private EntityManagerFactory entityManagerFactory(DataSource dataSource, Properties hibernateProperties ){
        ...
        em.setPackagesToScan( "com/example/java1il2022/week3/day14/demo3");
    ...
    public static void main(String[] args) {
        ...
        tx.begin();
//        Student stu = em.find(Student.class, "14");
//        Teacher teacher = em.find(Teacher.class, "9");
//        Teacher_Student ts = new Teacher_Student();
//        ts.setTeacher(teacher);
//        ts.setStu(stu);
//        em.persist(ts);
//        Student stu = new Student(); //transient status
//        stu.setName("Tom");
//        em.persist(stu);
        //-------------------------------------------------------
//        //1 query -> N student
//        //N query -> N  * getTeacher_students
//        for(Student stu: (List<Student>)em.createQuery("SELECT s FROM Student s").getResultList()) {
//            System.out.println(stu.getTeacher_students());
//        }
        List<Student> stu = (List<Student>) em.createQuery("SELECT s FROM Student s join s.teacher_students").getResultList();
